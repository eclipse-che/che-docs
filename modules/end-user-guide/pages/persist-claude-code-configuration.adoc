...
To distribute team-authored skills, commands, and agents without persisting the full Claude Code configuration, see xref:distribute-claude-code-skills-with-lola.adoc[].
