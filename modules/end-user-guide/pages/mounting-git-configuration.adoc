...
This procedure describes how to mount a Git config file to a workspace.
...
<2> Your Git user's name and email.
...
. Once the workspace is started, open a new terminal in the `tools` container and run `git config --get-regexp user.*`. You should observe your Git user's name and email in the output.
