...
* Your administrator has configured a GitHub OAuth App with Device Flow enabled as described in xref:integrate:configuring-oauth-2-for-github.adoc[Configuring OAuth 2.0 for GitHub].
+
...
* xref:integrate:configuring-oauth-2-for-github.adoc[]
