...
After applying the Secret, you can create workspaces with clones of a private Git repository that is hosted on GitHub, GitLab, Bitbucket, or Microsoft Azure Repos.
