...
After applying the Secret, you can create new workspaces from a private Git repository that is hosted on GitHub, GitLab, Bitbucket, or Microsoft Azure Repos.
