...
[TIP]
====
If you have the link:https://www.gnu.org/software/coreutils/base64[base64] command-line tools installed, you can use the command line:
...
* You can switch to your {prod-short} user namespace on the command line if needed:
+
[subs="+quotes,+attributes,+macros"]
----
