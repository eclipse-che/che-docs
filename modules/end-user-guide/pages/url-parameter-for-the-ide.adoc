...
If the URL for starting a new workspace doesn't contain a parameter specifying the integrated development environment (IDE), the workspace loads with the default IDE, Microsoft Visual Studio Code - Open Source.
