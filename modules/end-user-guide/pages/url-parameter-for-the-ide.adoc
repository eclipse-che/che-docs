...
----
<1> You can supply a URL to a xref:defining-a-common-ide.adoc[`che-editor.yaml`]  file or another file with link:https://devfile.io/docs/2.2.0/what-is-a-devfile[devfile content].
+
