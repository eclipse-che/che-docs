...
* Your administrator sets up an xref:secure:configuring-oauth-for-git-providers.adoc[OAuth application on GitHub, GitLab, Bitbucket, or Microsoft Azure Repos] for your organization's {prod} instance.
...
* xref:secure:configuring-oauth-for-git-providers.adoc[Administration Guide: Configuring OAuth for Git providers]
