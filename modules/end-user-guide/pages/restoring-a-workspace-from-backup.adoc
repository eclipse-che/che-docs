...
* **Internal backups**: Backups that the {prod-short} dashboard detects and lists automatically. On {ocp}, these are represented as `ImageStream` resources in your namespace.
*

* **External backups**: Backups from a registry not specified during the initial cluster-wide backup configuration.
