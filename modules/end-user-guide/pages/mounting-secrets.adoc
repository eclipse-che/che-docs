...
* xref:configuring-an-ai-provider-api-key.adoc[] (the {prod-short} dashboard uses this same auto-mount mechanism to inject AI provider API keys into workspaces)
