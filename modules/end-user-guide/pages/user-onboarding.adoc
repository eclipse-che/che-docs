...
Beyond this, it's likely that your organization has its own onboarding needs regarding:

* Specific Git repositories
* Devfiles that reside in the specific Git repositories and that are responsible for workspace configuration
