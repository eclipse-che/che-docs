...
//I just looked up the procedure for this example. The procedure is underdeveloped. Parts of this example must end up in the procedure. A comprehensive rewrite is needed.
