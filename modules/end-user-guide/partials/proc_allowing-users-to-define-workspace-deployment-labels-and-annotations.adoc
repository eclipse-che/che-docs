...
. Display the deployment labels and annotations for all deployments in the namespace using the Namespace name from the first step:
+
[subs="+attributes,+quotes"]
----
...
////
=======
. To display the deployment labels:
+
[subs="+attributes,+quotes"]
----
$ oc get deployment -n {prod-namespace}  --show-labels
----
>>>>>>> 1a679d76fde335dced8a667e8605d5d5d3e89888
