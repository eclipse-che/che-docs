...
* In the remote Git repository of your project source code, create a `/.che/che-editor.yaml` file with lines that specify the relevant parameter, as described in xref:parameters-for-che-editor-yaml[Parameters for che-editor.yaml].
