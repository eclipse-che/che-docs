...
+
NOTE: To see a list of available plug-ins, activate the completion feature by pressing kbd:[Ctrl+Space].
+
image::workspaces/workspace-add-plugin.png[Adding a plug-in in a workspace]
...
+
NOTE: To see a list of available plug-ins, activate the completion feature by pressing kbd:[Ctrl+Space]. The recommended editor for {prod-short} {prod-ver} is Che-Theia.
+
