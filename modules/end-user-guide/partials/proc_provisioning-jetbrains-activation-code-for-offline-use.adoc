...
This section describes how to provision the JetBrains activation code to {prod-short}, when using link:https://sales.jetbrains.com/hc/en-gb/articles/206544639-What-is-JetBrains-Toolbox-[a JetBrains IDE requesting a registration]. After each subscription renewal, you need to generate an activation code and apply it to your product.

.Prerequisites

* An active link:https://account.jetbrains.com/login[JetBrains account].
* An active link:https://sales.jetbrains.com/hc/en-gb[personal or organization subscription].
