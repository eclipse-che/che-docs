...
* GitHub: https://docs.github.com/en/rest/users/users#get-a-user.
* GitLab: https://docs.gitlab.com/ee/api/users.html#for-normal-users.
* Bitbucket Server: https://developer.atlassian.com/server/bitbucket/rest/v802/api-group-users/#api-users-userslug-get. Get the `account_id` value.
