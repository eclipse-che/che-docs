...
+
. From the *Devfile* tab, edit YAML configuration of the workspace. See the xref:making-a-workspace-portable-using-a-devfile.adoc#devfile-reference_{context}[].
+
[TIP]
