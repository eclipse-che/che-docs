...
<24> Direct link or links to the `vsix` files included with this plug-in. The `vsix` built by the repository specified, such as the main extension, must be listed first.
<25> # TODO #
