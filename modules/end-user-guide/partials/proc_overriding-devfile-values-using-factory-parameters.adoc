...
[subs="+quotes"]
----
https://workspaces.openshift.com/f?url=url=https://github.com/eclipse/che-docs&override.metadata.generateName=myprefix
----
...
[subs="+quotes"]
----
https://workspaces.openshift.com/f?url=url=https://github.com/eclipse/che-docs&override.projects.web-java-spring-petclinic.source.branch=1.0.x
----
