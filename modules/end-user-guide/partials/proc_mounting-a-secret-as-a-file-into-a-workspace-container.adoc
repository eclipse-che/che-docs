...
In {prod-short}, you can mount a secret from your {orch-namespace} as a file in single-workspace or multiple-workspace containers.
...
<6> Sets the filename to mount (`settings.xml`).
