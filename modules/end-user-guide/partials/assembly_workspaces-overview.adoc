...
For additional information, see: xref:installation-guide:advanced-configuration-options-for-the-che-server-component.adoc#users-workspace-limits_{context}.
====
