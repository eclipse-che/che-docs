...
//As of this edit, this list contains only one entry at the time of writing this comment, hence commenting out the sentence on the previous line. max-cx
...
To add a plug-in from the Plug-in registry to an existing {prod-short} workspace, use one of the following methods:
