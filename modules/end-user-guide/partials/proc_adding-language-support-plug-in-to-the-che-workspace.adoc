...
** xref:creating-a-workspace-from-code-sample.adoc#creating-a-workspace-from-custom-workspace-view-of-user-dashboard_{context}[Creating a workspace from Get Started view of User Dashboard]
