...
* `discoverable`: If an endpoint is discoverable, it means that it can be accessed using its name as the host name within the workspace containers (in the {platforms-name} parlance, a service is created for it with the provided name).
55
