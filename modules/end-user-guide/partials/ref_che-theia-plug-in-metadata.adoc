...
Here is an overview of all fields that can be available in plugin meta YAML files. This document represents the link:https://github.com/eclipse/che-plugin-registry#https://github.com/eclipse/che-plugin-registry#user-content-plugin-meta-yaml-structure[Plugin meta YAML structure version 3].
