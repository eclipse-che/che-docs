...
* Starting from scratch: link:#including-kubernetes-applications-in-a-workspace-devfile-definition_{context}[Writing a new devfile]
...
include::partial$proc_{prod-id-short}-including-kubernetes-applications-in-a-workspace-devfile-definition.adoc[leveloffset=+1]
