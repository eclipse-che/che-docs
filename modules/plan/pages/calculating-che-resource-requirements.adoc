...
:keywords: plan, calculating-che-resource-requirements, sizing
:navtitle: Size your cluster for {prod-short}
:page-aliases: administration-guide:calculating-che-resource-requirements.adoc, install:calculating-che-resource-requirements.adoc
...
* You have a planned or existing {prod-short} deployment on {orch-name}.
