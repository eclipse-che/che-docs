...
:description: Review scalability limits, etcd bottlenecks, and multi-cluster deployment patterns so that you can plan infrastructure that handles your team's concurrent workspace load.
...
:page-aliases: administration-guide:running-at-scale.adoc, install:running-at-scale.adoc
...
== How disabling Copied CSVs reduces etcd usage
...
== How worker node capacity matches workspace demand
...
== How workloads are distributed across multiple clusters
...
== How the redirector routes developers to the correct cluster
...
== How OpenShift groups map to cluster URLs
...
* link:https://kubernetespodcast.com/episode/111-scalability/["Scalability, with Wojciech Tyczynski" episode of Kubernetes Podcast]
* link:https://www.redhat.com/en/technologies/cloud-computing/openshift[{ocp}]
