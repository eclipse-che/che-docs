...
= Access {prod-short} from the Red Hat Applications menu

Access {prod-short} workspaces from the *Red Hat Applications* menu on the OpenShift Container Platform.
