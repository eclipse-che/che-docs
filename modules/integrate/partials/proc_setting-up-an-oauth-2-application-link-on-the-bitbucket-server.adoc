...
:description: Create an OAuth 2.0 application link on the Bitbucket Server
:keywords: bitbucket, bitbucket-server, application-link, oauth2
:navtitle: Create an OAuth 2.0 application link on the Bitbucket Server
// :page-aliases:
...
Create an OAuth 2.0 application link on the Bitbucket Server so that {prod-short} can authenticate your developers and provide credential-free access to Bitbucket Server repositories.
