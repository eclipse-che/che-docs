...
:description: Create a Microsoft Entra ID application for {prod-short}
:keywords: azure, devops, oauth
:navtitle: Create a Microsoft Entra ID application for {prod-short}
// :page-aliases:

pass:[<!-- vale RedHat.TermsWarnings = NO -->]

[id="setting-up-the-microsoft-entra-id-oauth-app"]
= Create a Microsoft Entra ID application for {prod-short}

Create a Microsoft Entra ID application so that {prod-short} can authenticate your developers and provide credential-free access to Azure DevOps repositories.
