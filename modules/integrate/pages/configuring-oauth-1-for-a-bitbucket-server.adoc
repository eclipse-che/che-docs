...
:description: Connect Bitbucket Server with OAuth 1.0 so that developers can push and pull code
...
:page-aliases: administration-guide:configuring-oauth-1-for-a-bitbucket-server.adoc
