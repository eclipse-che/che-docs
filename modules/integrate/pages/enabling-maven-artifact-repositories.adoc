...
:description: Enable a Maven artifact repository so that Java workspaces can resolve dependencies from your internal Nexus or Artifactory server.
...
Enable a Maven artifact repository so that Java workspaces can resolve dependencies from your internal Nexus or Artifactory server.
