...
:description: {prod-short} in the OpenShift Developer Perspective
...
[IMPORTANT]
====
Starting with {ocp} 4.19, the perspectives in the web console have unified to simplify navigation, reduce context switching, consolidate tasks, and provide users with a more cohesive {ocp} experience.
