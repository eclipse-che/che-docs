:page-aliases: administration-guide:proc_configure-internal-open-vsx-access.adoc
:_content-type: PROCEDURE
:description: Restrict the extension registry to internal cluster traffic
:keywords: administration guide, openvsx, security, internal, routing
:navtitle: Restrict the extension registry to internal traffic
...
* You have Open VSX deployed in the `openvsx` {orch-namespace}.
