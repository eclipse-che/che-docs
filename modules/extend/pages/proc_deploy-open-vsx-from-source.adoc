:page-aliases: administration-guide:proc_deploy-open-vsx-from-source.adoc
:_content-type: PROCEDURE
:description: Build a custom extension registry from source code and deploy it to your cluster
:keywords: administration guide, openvsx, build, deploy, registry, extensions
:navtitle: Build a custom extension registry from source
...
* You are logged in to the {orch-name} cluster where {prod-short} is deployed as a cluster administrator.
+
[TIP]
====
...
. Create a new {orch-namespace} for Open VSX:
+
