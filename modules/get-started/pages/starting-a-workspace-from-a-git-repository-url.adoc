...
* Your Git repository maintainer keeps the `devfile.yaml` or `.devfile.yaml` file in the root directory of the Git repository. (For alternative file names and file paths, see xref:develop:optional-parameters-for-the-urls-for-starting-a-new-workspace.adoc[].)
+
...
----
<1> See xref:develop:optional-parameters-for-the-urls-for-starting-a-new-workspace.adoc[].
====
+
[TIP]
====
...
* xref:develop:optional-parameters-for-the-urls-for-starting-a-new-workspace.adoc[]
