...
The action achieves this by listening to pull request events and providing a link:https://www.eclipse.org/che/docs/che-7/end-user-guide/creating-a-workspace-from-remote-devfile/#creating-a-workspace-from-the-default-branch-of-a-git-repository_che[factory URL] by creating a comment, a status check, or both.
