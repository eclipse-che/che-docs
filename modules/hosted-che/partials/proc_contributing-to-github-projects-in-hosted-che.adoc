...
* A workspace running in Eclipse Che hosted by Red Hat, including a project imported from GitHub. See xref:importing-projects-from-github-in-hosted-che_{context}[].
