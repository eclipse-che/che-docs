...
It is possible to disable the temporary storage mode while xref:hosted-che.adoc#creating-a-workspace-from-the-user-dashboard_{context}[creating a workspace from the user dashboard].
