...
* A GitHub repository
* A xref:end-user-guide:authoring-devfiles-version-2.adoc[devfile] in the root of the GitHub repository (see xref:providing-a-devfile_{context}[Providing a devfile])
