...
:page-aliases: installation-guide:configuring-namespace-strategies.adoc, configuring-namespace-strategies.adoc, administration-guide:configuring-namespace-provisioning.adoc
