...
:description: Customize the dashboard samples to display custom samples that reflect your organization's preferred languages, frameworks, and project templates.
:keywords: administration guide, configuring, dashboard, samples
:navtitle: Customize the dashboard samples for your team
...
Customize the Getting Started samples by replacing the defaults on the dashboard with repositories relevant to your team's projects and technology stack.
