...
:description: Apply custom branding images to the dashboard by overriding the default images in the assets/branding directory.
:keywords: administration guide, customizing, branding, images
:navtitle: Apply your organization's branding to the dashboard
...
Apply your organization's branding to the {prod} dashboard by overriding the default images in the `assets/branding` directory. The following images can be customized:
