...
:page-aliases: .:installing-image-puller-on-openshift-using-openshift-templates.adoc,installing-image-puller-on-openshift-using-openshift-templates.adoc, administration-guide:installing-image-puller-on-kubernetes-by-using-cli.adoc
