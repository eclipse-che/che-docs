...
:page-aliases: installation-guide:configuring-che-with-self-signed-certificate.adoc, administration-guide:configuring-che-with-self-signed-certificate.adoc
