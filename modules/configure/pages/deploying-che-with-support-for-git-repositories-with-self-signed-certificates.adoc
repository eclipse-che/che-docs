...
Trust self-signed certificates from your internal Git server so that workspaces can clone and push to repositories secured by internal certificate authorities.
