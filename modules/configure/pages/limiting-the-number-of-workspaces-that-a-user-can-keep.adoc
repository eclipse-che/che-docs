...
:page-aliases: configuring-the-number-of-workspaces-that-a-user-can-create.adoc, administration-guide:limiting-the-number-of-workspaces-that-a-user-can-keep.adoc
