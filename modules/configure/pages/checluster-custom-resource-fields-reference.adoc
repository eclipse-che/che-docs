...
:page-aliases: installation-guide:checluster-custom-resource-fields-reference.adoc, administration-guide:checluster-custom-resource-fields-reference.adoc
