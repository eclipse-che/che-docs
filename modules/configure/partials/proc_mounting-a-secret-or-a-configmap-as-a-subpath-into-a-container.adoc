...
.Secret and ConfigMap with subPath annotations
====
...
.Secret with a data key mounted as subPath
====
[source,yaml,subs="+quotes,attributes"]
----
apiVersion: v1
...
[IMPORTANT]
====
To make the changes in a {prod-short} container visible, re-create the Secret or the ConfigMap object entirely.
====
--
