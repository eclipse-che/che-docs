...
pass:[<!-- vale RedHat.OperatingSystem = NO -->]
pass:[<!-- vale RedHat.CaseSensitiveTerms = NO -->]

// pass:[<!-- vale RedHat.Slash = NO -->]
...
Eclipse Che4z is an open source project. Many of the components of the Che4z stack are also available on the Visual Studio Code marketplace as part of the https://marketplace.visualstudio.com/items?itemName=broadcomMFD.code4z-extension-pack[Code4z] package.
