[id="creating-a-telemetry-plugin-for-{devworkspace}s"]
...
. Extending {prod-short} libraries to create a back-end that sends events to the server
...
+
----
include::example$creating-a-telemetry-plug-in-for-devworkspaces/project_scaffolding.sh[]
----
...
[source,xml]
----
include::example$creating-a-telemetry-plug-in-for-devworkspaces/pom_snippet.xml[]
----
====
...
[source,xml]
----
include::example$creating-a-telemetry-plug-in-for-devworkspaces/settings.xml[]
----
====
+
...
[source,java]
----
include::example$creating-a-telemetry-plug-in-for-devworkspaces/MainConfiguration.java[]
----
====
...
[source,java]
----
include::example$creating-a-telemetry-plug-in-for-devworkspaces/AnalyticsManagerSkeleton.java[]
----
====
...
[source,java]
----
include::example$creating-a-telemetry-plug-in-for-devworkspaces/isEnabled.java[]
----
====
...
[source,java]
----
include::example$creating-a-telemetry-plug-in-for-devworkspaces/TelemetryService.java[]
----
====
...
[source,java]
----
include::example$creating-a-telemetry-plug-in-for-devworkspaces/onEvent.java[]
----
====
+
...
[source,java]
----
include::example$creating-a-telemetry-plug-in-for-devworkspaces/increaseDuration.java[]
----
====
...
[source,java]
----
include::example$creating-a-telemetry-plug-in-for-devworkspaces/onActivity.java[]
----
====
...
[source,java]
----
include::example$creating-a-telemetry-plug-in-for-devworkspaces/destroy.java[]
----
====
...
[source,yaml]
----
include::example$creating-a-telemetry-plug-in-for-devworkspaces/Dockerfile.jvm[]
----
====
...
[source,yaml]
----
include::example$creating-a-telemetry-plug-in-for-devworkspaces/Dockerfile.native[]
----
====
To build the image, run:
----
...
Create a `plugin.yaml` devfile v2 file representing a {devworkspace} plug-in that runs your custom back-end in a {devworkspace} Pod. For more information about devfile v2, see link:https://devfile.io/docs/[Devfile v2 documentation]

.`plugin.yaml`
====
[source,yaml]
----
include::example$creating-a-telemetry-plug-in-for-devworkspaces/plugin.yaml[]
----
====
...
----
include::example$creating-a-telemetry-plug-in-for-devworkspaces/webserver.yaml[]
----
====
...
+
image::creating-a-telemetry-plug-in-for-devworkspaces/devworkspace_telemetry_plugin.png[]
