...
To create a telemetry back-end plug-in for {devworkspace}s, refer to xref:extensions:creating-a-telemetry-plugin-for-devworkspaces.adoc[]
====
...
Create a `meta.yaml` definition representing a {prod-short} plug-in that runs your custom back-end in a workspace Pod. 
