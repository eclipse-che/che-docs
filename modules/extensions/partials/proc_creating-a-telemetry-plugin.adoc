...
In most cases, a user would deploy this file to a corporate web server. For this guide, create an Apache web server on OpenShift and host the plug-in there.
