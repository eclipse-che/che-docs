...
* A running instance of {prod-short}. See xref:administration-guide:installing-che.adoc[].

* A {prod-short} workspace is available. See xref:end-user-guide:using-developer-workspaces.adoc[].
