...
*** xref:enabling-readiness-init-containers-for-operator-installer.adoc[]
*** xref:disabling-readiness-init-containers-for-operator-installer.adoc[]
** xref:enabling-and-disabling-readiness-init-containers-for-olm-installer.adoc[]
*** xref:enabling-readiness-init-containers-for-olm-installer.adoc[]
*** xref:disabling-readiness-init-containers-for-olm-installer.adoc[]
