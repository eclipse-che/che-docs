...
To configure an Amazon S3 compatible backup server for {prod-short}:
//API compatible in this case means what? Compatible with Amazon S3, API-compatible with S3, or compatible with any APIs in general? max-cx
