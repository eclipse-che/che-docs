...
** If the extension is published on link:https://open-vsx.org[open-vsx.org], you can copy and use the *Unique identifier* from the extension's listing page on link:https://open-vsx.org[open-vsx.org]:
+
[source,json,subs="+quotes"]
----
    {
        "id": "__<Unique_identifier>__"
    }
----
+
[TIP]
