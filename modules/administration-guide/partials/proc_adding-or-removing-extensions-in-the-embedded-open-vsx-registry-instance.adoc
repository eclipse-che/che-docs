...
** If the extension is published on link:https://open-vsx.org[open-vsx.org], you can copy and use the publisher and extension names from the extension's listing page:
+
