...
. Save the Base64-encoded `privatepkcs8-stripped.pem` file for use when xref:assembly_configuring-oauth-1-for-bitbucket.adoc#applying-the-bitbucket-application-link-secret_{context}[].
...
. Save the Base64-encoded `bitbucket_consumer_key` file for use when xref:assembly_configuring-oauth-1-for-bitbucket.adoc#applying-the-bitbucket-application-link-secret_{context}[].
...
. Save the Base64-encoded `bitbucket-shared-secret` file for use when xref:assembly_configuring-oauth-1-for-bitbucket.adoc#applying-the-bitbucket-application-link-secret_{context}[].
