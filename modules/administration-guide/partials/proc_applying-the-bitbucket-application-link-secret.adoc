...
Enable the users of your {prod-short} instance to access a private Git repository that is hosted using Bitbucket:

.Prerequisites
* xref:user-guide:setting-up-the-bitbucket-application-link.adoc[] has been completed.
* The following files that were created when xref:user-guide:setting-up-the-bitbucket-application-link.adoc[]:
