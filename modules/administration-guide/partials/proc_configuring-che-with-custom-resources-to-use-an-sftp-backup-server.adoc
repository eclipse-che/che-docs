...
----
+
({prod-short} Operator will set up this password for the backup repository that {prod-short} Operator will create from this custom object on the backup server.)
+
