...
Control the desired state of the User workspaces. The main component is the User dashboard, which displays the running workspaces.

{devworkspace} operator::
Manages the running state of the User workspaces.
The {devworkspace} operator stops a workspace after 30 minutes of inactivity. This duration is configurable.
