...
This section describes installing the link:https://github.com/che-incubator/kubernetes-image-puller[{image-puller-name-short}] on a {prod-short} cluster to cache images on cluster nodes.
