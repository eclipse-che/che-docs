...
The optional internal backup server can be used to create backups for testing purposes. The internal backup server is a REST backup server that is managed by the {prod-short} Operator.
