...
<4> The content of the `bitbucket-consumer-key` file, which you manually encoded to Base64 in step 1.
<5> The content of the `bitbucket-shared-secret` file, which you manually encoded to Base64 in step 2.
