...
. Determine xref:con_setting-up-a-backup-server.adoc#supported-backup-servers[backup server type] and the server URL, using the link:https://restic.readthedocs.io/en/latest/030_preparing_a_new_repo.html[restic repository documentation] as the reference.
