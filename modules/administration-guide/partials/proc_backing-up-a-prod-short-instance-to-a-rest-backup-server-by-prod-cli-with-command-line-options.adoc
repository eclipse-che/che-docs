...
You can use {prod-cli} with command-line options to take a backup snapshot of a {prod-short} instance and to send the backup snapshot to a configured REST backup server.
