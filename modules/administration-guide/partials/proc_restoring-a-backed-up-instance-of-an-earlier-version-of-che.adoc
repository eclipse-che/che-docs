...
<2> Specifies the snapshot ID. (If you keep a dedicated backup repository for each {prod-short} version and want to use the most recent backup of that version, then you can enter it as `--snapshot-id=latest`.)
