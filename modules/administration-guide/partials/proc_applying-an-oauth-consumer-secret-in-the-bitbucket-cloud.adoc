...
:description: Applying an OAuth consumer Secret in the Bitbucket Cloud
:keywords: bitbucket, bitbucket-cloud, oauth-consumer, bitbucket-consumer, oauth-consumer-secret, bitbucket-client-secret
:navtitle: Applying an OAuth consumer Secret in the Bitbucket Cloud
// :page-aliases:

[id="applying-an-oauth-consumer-secret-in-the-bitbucket-cloud_{context}"]
= Applying an OAuth consumer Secret in the Bitbucket Cloud

Prepare and apply an OAuth consumer Secret in the Bitbucket Cloud.
