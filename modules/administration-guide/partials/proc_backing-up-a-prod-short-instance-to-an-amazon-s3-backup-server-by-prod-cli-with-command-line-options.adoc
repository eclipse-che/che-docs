...
To take a backup snapshot of a {prod-short} instance and to send the snapshot to a configured Amazon S3 backup server, run {prod-cli} with the command-line options.
