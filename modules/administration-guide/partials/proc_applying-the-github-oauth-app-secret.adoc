...
.Prerequisites
* xref:assembly_configuring-oauth-2-for-github.adoc#setting-up-the-github-oauth-app_{context}[] is completed.
* The Base64-encoded values, which were generated when xref:assembly_configuring-oauth-2-for-github.adoc#setting-up-the-github-oauth-app_{context}[], are prepared:
