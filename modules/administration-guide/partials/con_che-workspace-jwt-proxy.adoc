...
The JWT proxy is responsible for securing the communication of the {prod-short} workspace services. The {prod-short} workspace JWT proxy is included in a {prod-short} workspace only if the {prod-short} server is configured in multiuser mode.
