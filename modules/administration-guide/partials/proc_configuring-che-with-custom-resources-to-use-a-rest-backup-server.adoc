...
----
+
({prod-short} Operator setup up this password for the backup repository that {prod-short} Operator will create from this custom object on the external backup server.)
+
