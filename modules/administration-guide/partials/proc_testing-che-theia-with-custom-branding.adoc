...
[id="testing-che-theia-with-custom-branding"]
...
+
include::administration-guide:example$snip_{project-context}-clone-the-plugin-registry-repository.adoc[]
...
. Build the registry:
+
include::administration-guide:example$snip_{project-context}-build-a-custom-plugin-registry.adoc[]
...
+
image::contribute.svg[link="https://workspaces.openshift.com/f?url=https://raw.githubusercontent.com/che-samples/che-theia-branding-example/master/devfile.yaml"]
+
