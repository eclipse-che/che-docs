...
[NOTE]
====
If reusing the name of an existing backup custom object for a new backup custom object, first delete the old custom object. To delete it on the command line, use {orch-cli}:
