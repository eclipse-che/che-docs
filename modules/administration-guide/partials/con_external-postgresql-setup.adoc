...
* xref:proc_configuring-external-postgresql.adoc[Configure the external PostgreSQL.]

* xref:proc_configuring-prod-short-to-work-with-external-postgresql.adoc[Configure {prod-short} to work with the configured external PostgreSQL.]
