...
. Install Keycloak:
+
IMPORTANT: While this guide provides a development configuration for deploying Keycloak on {kubernetes}, keep in mind that production environments require different settings, for instance configuring external databases.
+
[source,subs="+attributes"]
----
