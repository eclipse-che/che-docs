...
. Add valid content in the `devfile.yaml` file. For a detailed description of the devfile format, see xref:end-user-guide:making-a-workspace-portable-using-a-devfile.adoc[].
