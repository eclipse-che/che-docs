...
[NOTE]
====
Where to find the snapshot ID of a backup snapshot:

* Command line output when creating a backup
* Custom Resource status
* restic command to link:https://restic.readthedocs.io/en/stable/045_working_with_repos.html[list snapshots in the backup repository]
