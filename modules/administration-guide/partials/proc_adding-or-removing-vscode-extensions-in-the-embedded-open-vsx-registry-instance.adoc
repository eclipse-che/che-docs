...
* If you have a closed-source extension or an extension developed only for internal use in your company, you can add the extension directly from a `.vsix`file by using a URL accessible to your custom plugin registry container build:
+
[source,json,subs="+quotes"]
----
    {
