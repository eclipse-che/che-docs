...
WARNING: After a {prod-short} update, you may choose to build a new registry container based on the updated {prod-short} container, in order to get the latest security fixes and updates.
