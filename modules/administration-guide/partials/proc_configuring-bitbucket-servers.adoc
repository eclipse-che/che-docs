...
You can use the Bitbucket (BB) server as a project source supplier in {prod-short}}. To do so, configure the related CheCluster Custom Resource (CR) and {prod-short} instance YAML file.
