...
include::partial$proc_creating-secure-servers.adoc[leveloffset=+1]

include::partial$con_workspace-jwt-token.adoc[leveloffset=+1]

include::partial$con_machine-token-validation.adoc[leveloffset=+1]
