...
* Valid content for the devfile to add. See: xref:end-user-guide:authoring-devfiles.adoc[].
...
. Add valid content in the `devfile.yaml` file. For a detailed description of the devfile format, see xref:end-user-guide:authoring-devfiles.adoc[].
