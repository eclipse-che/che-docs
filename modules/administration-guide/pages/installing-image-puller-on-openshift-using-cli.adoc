...
:page-aliases: .:installing-image-puller-on-openshift-using-openshift-templates,installing-image-puller-on-openshift-using-openshift-templates

[id="installing-image-puller-on-openshift-using-cli_{context}"]
= Installing {image-puller-name-short} on OpenShift using CLI

This procedure describes how to install the {image-puller-name} on OpenShift using OpenShift `oc` management tool.
