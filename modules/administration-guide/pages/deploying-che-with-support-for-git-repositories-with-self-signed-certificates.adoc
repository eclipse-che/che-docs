...
<2> Optional parameter to specify the Git server URL. When omitted, the self-signed certificate is used for all repositories over HTTPS. For instance `https://git.example.com:8443`.
+
[NOTE]
====
