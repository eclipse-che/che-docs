...
:page-aliases: installation-guide:understanding-the-checluster-custom-resource, installation-guide:configuring-che, installation-guide:checluster-custom-resource-fields-reference 
