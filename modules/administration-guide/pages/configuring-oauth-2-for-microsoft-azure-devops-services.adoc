...
To enable users to work with a remote Git repository that is hosted on link:https://azure.microsoft.com/en-us/products/devops/repos/[Microsoft Azure Repos]:
