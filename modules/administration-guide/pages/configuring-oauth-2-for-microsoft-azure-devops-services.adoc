...
:keywords: configuring-oauth, authorization, microsoft azure devops, microsoft azure repos, oauth-2, oauth-2.0
:navtitle: Configuring OAuth 2.0 for Microsoft Azure DevOps Service
:page-aliases:
