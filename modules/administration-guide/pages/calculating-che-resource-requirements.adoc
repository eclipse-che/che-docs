...
{prod-short} operator, {devworkspace} controller, and user workspaces consist of a set of pods. Those pods contribute to the resources consumption in terms of CPU and RAM limits and requests.
