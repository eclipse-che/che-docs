...
. Calculate the sums of the resources required for each workspace, and multiply them by the number of workspaces that you expect all of your users to run simultaneously.
