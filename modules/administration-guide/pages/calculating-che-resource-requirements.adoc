...
** To learn how to calculate resources such as memory and CPU that are required to run one workspace, you can examine the linked link:https://github.com/che-incubator/quarkus-api-example/blob/main/devfile.yaml[example devfile] and identify the following components in it:
+
.`tools`
====
