...
To manage extensions, the link:https://github.com/microsoft/vscode[Microsoft Visual Studio Code - Open Source] IDE of the workspace uses an link:https://open-vsx.org/about[Open VSX] registry instance:
