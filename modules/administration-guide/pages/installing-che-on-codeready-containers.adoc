...
:parent-context-of-installing-che-on-red-hat-openshift-local: {context}

[id="installing-{prod-id-short}-on-red-hat-openshift-local_{context}"]
= Installing {prod-short} on {rh-os-local}

:context: installing-{prod-id-short}-on-red-hat-openshift-local
...
* link:https://access.redhat.com/documentation/en-us/red_hat_openshift-local/[Product documentation for {rh-os-local}].
