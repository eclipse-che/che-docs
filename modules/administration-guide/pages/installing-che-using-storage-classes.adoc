...
{prod-short} has one component that requires persistent volumes to store data: A {prod-short} workspace. {prod-short} workspaces store source code using volumes, for example the  `/projects` volume.
