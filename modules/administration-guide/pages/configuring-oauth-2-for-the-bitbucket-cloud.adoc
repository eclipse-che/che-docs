...
. Apply an Bitbucket OAuth consumer Secret in the Bitbucket Cloud.

include::partial$proc_setting-up-an-oauth-consumer-in-the-bitbucket-cloud.adoc[leveloffset=+1]

include::partial$proc_applying-an-oauth-consumer-secret-in-the-bitbucket-cloud.adoc[leveloffset=+1]