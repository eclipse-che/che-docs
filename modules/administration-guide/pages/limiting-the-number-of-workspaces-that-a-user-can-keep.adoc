...
spec:
  components:
    cheServer:
      extraProperties:
        CHE_LIMITS_USER_WORKSPACES_COUNT: "__<max_count_of_kept_workspaces_per_user>__" <1>
----
...
--type='merge' -p '{"spec":{"components":{"cheServer":{"extraProperties":{"CHE_LIMITS_USER_WORKSPACES_COUNT":"__<max_count_of_kept_workspaces_per_user>__"}}}}}' <2>
----
<1> The namespace you got in step 1.
<2> The `__<max_count_of_workspaces_per_user>__` value you set in step 2.
