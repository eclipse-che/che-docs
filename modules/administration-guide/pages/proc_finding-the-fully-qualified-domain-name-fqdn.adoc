...
:description: Finding the FQDN of a {prod-short} instance
...
[role="_abstract"]
Retrieve the fully qualified domain name (FQDN) of your organization's instance of {prod-short} on the command line to access the {prod-short} dashboard URL.
