...
. Create the `my-editor-definition-devfile.yaml` YAML file with the editor definition configuration in the namespace where CheCluster Custom Resource is located.
+
[IMPORTANT]
====
