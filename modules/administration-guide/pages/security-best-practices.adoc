...
For detailed instructions on implementing network policies with {prod}, see xref:configure:configuring-network-policies.adoc[].
...
include::install:example$snip_che-installation-instructions.adoc[]
