...
[id="installing-image-puller-using-{prod-id-short}-operator_{context}"]
...
* The {prod-short} Operator is available. See xref:installing-che-on-openshift-4-using-operatorhub.adoc[]
