...
IMPORTANT: To uninstall an instance of {prod} that was installed using the `{prod-cli}` tool on the {ocp} or {osd}, go to xref:uninstalling-che-by-using-chectl.adoc[].
