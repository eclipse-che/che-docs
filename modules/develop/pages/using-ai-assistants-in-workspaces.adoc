...
:description: {prod-short} supports AI coding assistants that are injected into workspaces and available from the terminal.
:keywords: user-guide, ai, ai assistant, ai provider, ai selector
:navtitle: AI assistants in Cloud Development Environments
:page-aliases:
