...
You can automate installation of Microsoft Visual Studio Code extensions from the Open VSX registry at workspace startup. See _Automating installation of Microsoft Visual Studio Code extensions at workspace startup_. For AI-assisted coding with GitHub Copilot Chat in this IDE, see Additional resources.
