...
:description: How kubedock works
:keywords: kubedock, container
:navtitle: How kubedock works
:page-aliases:
...
[role="_abstract"]
Kubedock is a minimal container engine implementation that gives you a Podman-/docker-like experience inside an {prod-short} workspace.
...
[IMPORTANT]
====
The image you want to use with kubedock must be compliant with {ocp} image creation guidelines.
Otherwise, running the image with kubedock results in a failure even if the same image runs locally without issues.
====
...
* link:https://github.com/joyrex2001/kubedock[Kubedock GitHub repository]
* link:https://testcontainers.com/[Testcontainers]
* link:https://quarkus.io/guides/dev-services[Quarkus Dev Services]
* link:https://docs.openshift.com/container-platform/{ocp4-ver}/openshift_images/create-images.html#images-create-guide-openshift_create-images[{ocp} image creation guidelines]
