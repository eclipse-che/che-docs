...
:page-aliases: end-user-guide:starting-a-workspace-from-a-raw-devfile-url.adoc, get-started:starting-a-workspace-from-a-raw-devfile-url.adoc
...
To configure the Git credentials, use the xref:get-started:using-a-git-provider-access-token.adoc[configure personal access token] guide.
====
+
[TIP]
====
...
* xref:get-started:basic-actions-you-can-perform-on-a-workspace.adoc[]
