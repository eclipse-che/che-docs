...
* Git credentials configured in the workspace if the repository is private. See xref:get-started-user:authenticating-to-a-git-server-from-a-workspace.adoc[].
...
* xref:get-started-user:authenticating-to-a-git-server-from-a-workspace.adoc[]
