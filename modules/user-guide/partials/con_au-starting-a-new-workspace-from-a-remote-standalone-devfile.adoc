REWRITE THE FOLLOWING AS AN ADVANCED USE PROCEDURE, INCORPORATING ANY RELEVANT LINKS INFO:
...
include::snip_uo-adding-links-for-starting-a-new-workspace-to-the-browser.adoc[]