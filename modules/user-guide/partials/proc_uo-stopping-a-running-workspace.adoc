...
//You may stop your running workspace manually, or it may stop automatically due to reaching an idle timeout limit or a running timeout limit (as set by the administrator of your {prod-short} instance).
