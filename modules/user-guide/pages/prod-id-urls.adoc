...
* xref:url-of-your-organizations-prod-id-instance.adoc[URL of your {prod-short} dashboard]
* xref:url-of-your-organizations-prod-id-instance.adoc[URLs for starting a new workspace]
* xref:url-of-your-organizations-prod-id-instance.adoc[URLs of your workspaces]