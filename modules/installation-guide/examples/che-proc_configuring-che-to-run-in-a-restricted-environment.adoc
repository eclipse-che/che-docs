...
| a host name of the container-image registry, accessible in the restricted environment, see xref:pulling-images-used-by-che-to-a-private-registry_{context}[]
