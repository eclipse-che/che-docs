...
nativeUserMode: Enables native user mode. Currently works only on OpenShift and DevWorkspace operator. Native User mode uses OpenShift OAuth directly as identity provider, without Keycloak.
