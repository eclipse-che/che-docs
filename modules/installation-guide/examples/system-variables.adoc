...
,=== 
 ...
 `+CHE_INFRA_OPENSHIFT_ROUTE_HOST_DOMAIN__SUFFIX+`,"`+NULL+`","The hostname that should be used as a suffix for the workspace routes. For example host=open.che.org then the route will look like routed3qrtk.open.che.org It has to be a valid DNS name." 
,=== 
