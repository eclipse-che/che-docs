...
+
image::installation/aws-lauch-instance.png[link="../_images/installation/aws-lauch-instance.png"]
+
It is located under the *Description* tab, in the *IAM role* field.
+
image::installation/describtion-tab-iam-role.png[link="../_images/installation/describtion-tab-iam-role.png"]
...
+
image::installation/aws-summary-iam-role.png[link="../_images/installation/aws-summary-iam-role.png"]
...
+
image::installation/aws-hosted-zones-dns.png[link="../_images/installation/aws-hosted-zones-dns.png"]
+
