...
:parent-context-of-mounting-a-secret-or-a-configmap-as-a-file-into-a-container:{context}
...
:context:mounting-a-secret-or-a-configmap-as-a-file-into-a-container
...
:context: {parent-context-of-mounting-a-secret-or-a-configmap-as-a-file-into-a-container}