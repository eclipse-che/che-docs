...
* xref:advanced-configuration-options-for-the-{prod-id-short}-server-component.adoc[] describes advanced configuration methods to use when the previous method is not applicable.
...
* xref:importing-tls-certificates-to-{prod-id-short}-server-java-truststore.adoc[]
