...
* xref:administration-guide:configuring-authorization.adoc#configuring-{prod-id-short}-to-use-external-keycloak_{context}[Configuring Che to use an external Keycloak installation]
