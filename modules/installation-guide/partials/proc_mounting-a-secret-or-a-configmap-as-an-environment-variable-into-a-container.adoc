...
:parent-context-of-mounting-a-secret-or-a-configmap-as-an-environment-variable-into-a-container: {context}
...
:context: mounting-a-secret-or-a-configmap-as-an-environment-variable-into-a-container
...
include::partial$proc_mounting-a-secret-or-a-configmap-into-a-container.adoc[leveloffset=+1]
...
:context: {parent-context-of-mounting-a-secret-or-a-configmap-as-an-environment-variable-into-a-container}