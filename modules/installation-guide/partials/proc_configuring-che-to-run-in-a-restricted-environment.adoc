...
| a host name of the container-image registry (which is accessible in the restricted environment, see xref:proc_pulling-images-used-by-che-to-a-private-registry.adoc[])
