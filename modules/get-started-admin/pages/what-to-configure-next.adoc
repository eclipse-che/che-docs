...
| xref:configure:configuring-workspaces-globally.adoc[Set workspace policies for all users]
...
| xref:configure:understanding-the-checluster-custom-resource.adoc[Customize the central configuration]
