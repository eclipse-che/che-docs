...
:description: Debug a failing workspace
:keywords: user-guide, debug, workspace, troubleshooting
:navtitle: Debug a failing workspace
:page-aliases: end-user-guide:debugging-a-workspace.adoc
...
* You have access to the {prod-short} dashboard.
