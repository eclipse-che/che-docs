...
* Following the xref:running-che-locally.adoc[] to get {prod} installed locally on your computer.
...
//include::partial$con_introductory-videos.adoc[leveloffset=+1]

//include::partial$con_features-and-benefits.adoc[leveloffset=+1]

include::partial$ref_che-7-known-issues.adoc[leveloffset=+1]
