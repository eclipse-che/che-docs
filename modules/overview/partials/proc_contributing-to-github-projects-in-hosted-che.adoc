...
* A workspace running in Hosted Che, including a project imported from GitHub. See xref:proc_importing-projects-from-github-in-hosted-che.adoc[Importing projects from GitHub in Hosted Che].
