...
+
.Adding a workspace
image::extensibility/adding-workspace.png[link="../_images/extensibility/adding-workspace.png"]

. Select the *{prod-short} {prod-ver} Dev* stack, and click the btn:[CREATE & OPEN] button.
+
.Choosing the '{prod-short} {prod-ver} Dev' stack
image::extensibility/choosing-che-7-dev-stack.png[link="../_images/extensibility/choosing-che-7-dev-stack.png"]
