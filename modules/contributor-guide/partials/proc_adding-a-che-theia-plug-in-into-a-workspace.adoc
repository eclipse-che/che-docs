...
image::extensibility/adding-plug-ins-in-dashboard.png[link="../_images/extensibility/adding-plug-ins-in-dashboard.png"]
...
image::extensibility/adding-plug-ins-in-workspace-devfile.png[link="../_images/extensibility/adding-plug-ins-in-workspace-devfile.png"]
