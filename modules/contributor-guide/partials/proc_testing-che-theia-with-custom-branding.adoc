...
+
image::https://www.eclipse.org/che/contribute.svg[link="https://workspaces.openshift.com/#https://raw.githubusercontent.com/che-samples/che-theia-branding-example/master/devfile.yaml"]
+
