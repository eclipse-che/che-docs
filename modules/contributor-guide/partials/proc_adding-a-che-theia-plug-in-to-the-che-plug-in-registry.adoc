...
* Submit a pull request to link:{url-plug-in-registry-repo}[the plug-in registry repository] containing the `meta.yaml` file of the plug-in in the `v3/plugins/__<plugin-publisher>__/__<plugin-name>__/__<plug-in-version>__/` directory.
+
