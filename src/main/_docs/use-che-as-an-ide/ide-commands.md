...
| `${server.<port>.protocol}` | Returns protocol of a server registered by name   
| `${server.<port>.hostname}` | Returns hostname of a server registered by name   
| `${server.<port>.port}` | Returns port of a server registered by name
