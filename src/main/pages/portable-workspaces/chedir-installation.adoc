...
Installing Chedir is extremely easy. Just link:docker[get the Che CLI] and you have everything you need to run Chedir on any operating system. Docker and Git Bash (installed by Docker) are required for the Che CLI.
