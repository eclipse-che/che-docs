...
. Click the *Duplicate stack* icon for the stack that you want to create a clone of. The <stack-name> page opens.
...
. In the *Dashboard*, from the left panel, click *Stacks*.
