...
* The `pullrequest` mixin requires additional configuration from the `attributes` object of the project. If present, Che uses the project attributes as defined in the factory. If not provided, Che uses set defaults for the attributes.
