...
// include statement:
// include::<path>/assembly_che-workspace-configuration.adoc[leveloffset=+1]
...
The following sections describe the properties of the Che server that affect the provisioning of a Che workspace.
