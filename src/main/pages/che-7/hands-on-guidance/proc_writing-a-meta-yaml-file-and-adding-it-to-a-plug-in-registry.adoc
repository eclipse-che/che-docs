...
The plug-in meta information is required to publish a VS Code extension in an Eclipse Che plug-in registry. This meta information is provided as a `meta.yaml` file. To create a `meta.yaml` file for an extension, see the following instructions.
...
<15> A list of VA Code extensions that should be run in this sidecar container.
