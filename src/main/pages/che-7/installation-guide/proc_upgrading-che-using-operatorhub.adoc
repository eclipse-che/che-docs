...
This section describes how to upgrade from previous minor version using the Operator from OperatorHub in the OpenShift web console.

.Prerequisites

* An administrator account on an OpenShift instance.

* An instance of a previous minor version of {prod-short}, installed using an Operator from OperatorHub on the same instance of OpenShift.
