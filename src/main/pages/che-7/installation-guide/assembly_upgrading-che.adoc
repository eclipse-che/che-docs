...
* xref:upgrading-from-{prod-id-short}-6-on-openshift-4-using-the-web-console_{context}[]
...
include::proc_upgrading-from-{prod-id-short}-6-on-openshift-4-using-the-web-console.adoc[leveloffset=+1]
