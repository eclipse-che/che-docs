...
----
$ kubectl patch checluster _<{prod-deplyoment}-cluster>_ --type=json -n _<{prod-deplyoment}-namespace>_ --patch '_<requested-patch>_'
----
...
[subs="+quotes,+attributes",options="nowrap",role=white-space-pre]
----
$ oc patch checluster _<{prod-deplyoment}-cluster>_ --type=json -n _<{prod-deplyoment}-namespace>_ --patch '_<requested-patch>_'
----
