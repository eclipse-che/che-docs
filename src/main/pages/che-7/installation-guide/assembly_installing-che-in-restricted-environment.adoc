...
* Block-based storage volume or NFS share available outside of the cluster to serve dynamic storage provisioning or PVs. Block-based storage is highly recommended for the optimal performance. 
...
include::proc_pulling-images-used-by-{prod-id-short}-to-a-private-registry.adoc[leveloffset=+1]
include::proc_configuring-{prod-id-short}-to-run-in-a-restricted-environment.adoc[leveloffset=+1]
