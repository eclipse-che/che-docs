...
[id='branding-{prod-id-short}-theia']
= Branding {prod-short}-Theia

:context: branding-che-theia

This chapter describes how to customize the {prod-short}-Theia interface and branding. Customization is possible for the following elements:
...
To start using the customized {prod-short}-Theia:

. Build a container image with the customized {prod-short}-Theia.
