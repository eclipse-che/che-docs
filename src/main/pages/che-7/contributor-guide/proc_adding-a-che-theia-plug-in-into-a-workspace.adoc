...
= Adding a {prod-short}-Theia plug-in into a workspace

There are three ways to add a {prod-short}-Theia plug-in into the {prod-short}-Theia IDE:

* Using the {prod-short}-Theia dashboard
