...
For more details about the `meta.yaml` structure, see link:{site-baseurl}che-7/what-is-a-che-theia-plug-in/#che-theia-plug-in-metadata_what-is-a-che-theia-plug-in[].
...
* link:{site-baseurl}che-7/what-is-a-che-theia-plug-in/#che-theia-plug-in-metadata_what-is-a-che-theia-plug-in[]
