...
* link:{site-baseurl}che-7/installing-openshift-connector-in-che[Installing OpenShift Connector in {prod}]

* link:{site-baseurl}che-7/authenticating-with-openshift-connector-from-che[Authenticating with OpenShift Connector from {prod}]

* link:{site-baseurl}che-7/creating-components-with-openshift-connector-in-che[Creating Components with OpenShift Connector in {prod}]
