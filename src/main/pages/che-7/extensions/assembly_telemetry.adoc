...
Create a `meta.yaml` definition representing a Che Plugin that runs your custom back-end in a workspace Pod. For more information on `meta.yaml`, see link:{site-baseurl}che-7/what-is-a-che-theia-plug-in/[What is a Che-Theia plug-in].
