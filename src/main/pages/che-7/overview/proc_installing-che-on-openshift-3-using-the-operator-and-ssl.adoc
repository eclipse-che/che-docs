...
* Prepare a YAML file `configuration.yaml` containing the configuration options. See link:{site-baseurl}che-7/configuring-the-che-installation[Configuring the {prod-short} installation].
