...
This section describes procedures to get started with Hosted {prod-short} that are not covered by link:{site-baseurl}che-7/workspaces-overview[Using developer environments - workspaces].
