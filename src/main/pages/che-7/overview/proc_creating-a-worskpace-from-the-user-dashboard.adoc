...
. In the *Storage Type* section, choose to have persistent storage attached or not.  For more details, see link:{site-baseurl}che-7/using-diffrent-type-of-storage[Using different type of storage ] 
