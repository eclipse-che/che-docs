...
The different services that are a part of the {prod-short} workspaces controller are shown in the following diagram. Note that Keycloak and PostgreSQL are only needed in the multi-user configuration.
