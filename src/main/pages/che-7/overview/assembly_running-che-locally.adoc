...
* *Multi-user*: Authenticated {prod-short}, suited for the cloud, for organizations and developer teams
...
* xref:using-kubespray-to-set-up-kubernetes_{context}[]
...
* xref:installing-{prod-id-short}-on-kubespray-using-{prod-cli}_{context}[]
...
== Deploying multiuser {prod-short} in multiuser mode
