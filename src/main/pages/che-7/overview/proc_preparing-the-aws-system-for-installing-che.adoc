...
. Add hosts on route 53 with this given hostname link:https://console.aws.amazon.com/route53/home?region=eu-west-1#hosted-zones[]:
...
+
// TODO: image::installation/aws-lauch-Instance.png[link="{imagesdir}/installation/aws-lauch-Instance.png"]
+
