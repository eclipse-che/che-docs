...
* Learning more about Eclipse Che: link:introduction-to-eclipse-che.html#what-is-eclipse-che[What is Eclipse Che] and link:che-architecture.html[Architecture overview]
