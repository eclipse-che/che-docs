...
* Browser-based IDEs, integration Eclipse Theia or any other web IDE (like Jupyter).  
* Support of most recent tooling protocol: Language Server Protocol, Debug Adapter Protocol.  
