...
* It can be based on Eclipse Che-Theia (as it is a framework to build a web IDE), such as Sirius:
+
...
* *Alternative IDEs* to provide specialized tooling within Eclipse Che. Build your own, based on Eclipse Che-Theia, or pick existing ones like Jupyter.
