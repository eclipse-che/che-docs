...
* Learning more about {prod}: xref:what-is-eclipse-che[What is {prod}] and link:{site-baseurl}che-7/high-level-{prod-id-short}-architecture[Architecture overview]
