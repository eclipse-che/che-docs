...
See the link:{site-baseurl}che-7/installing-{prod-id-short}-on-openshift-3-using-the-operator[Installing {prod-short} on OpenShift 3 using the Operator] section.