...
//* Use the Che Dashboard to navigate the application and select predefined stacks
...
include::pages/che-7/overview/proc_running-che-locally.adoc[leveloffset=+1]
