...
include::proc_configuring-prod-short-to-use-external-keycloak.adoc[leveloffset=+1]

include::proc_configuring-che-to-use-external-keycloak.adoc[leveloffset=+1]

ifeval::["{project-context}" == "che"]
include::proc_configuring-che-to-work-without-identity-provider.adoc[leveloffset=+1]
endif::[]
