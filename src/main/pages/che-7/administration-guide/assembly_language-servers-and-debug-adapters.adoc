:parent-context-of-language-servers-and-debug-adapters: {context}

[id='language-servers-and-debug-adapters_{context}']
= Language servers and debug adapters

:context: language-servers-and-debug-adapters

include::proc_language-servers-and-debug-adapters.adoc[leveloffset=+1]
...
include::proc_viewing-logs-for-java.adoc[leveloffset=+1]
...
:context: {parent-context-of-language-servers-and-debug-adapters}
