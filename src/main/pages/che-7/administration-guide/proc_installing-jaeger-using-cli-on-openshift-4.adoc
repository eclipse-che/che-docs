...
. Follow the steps in link:{site-baseurl}che-7/tracing-che/#enabling-che-traces-collections_installing-the-jaeger-tracing-tool[Enabling metrics collections] to finish the procedure.
