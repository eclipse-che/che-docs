...
include::proc_viewing-the-typescript-language-server-log.adoc[leveloffset=+1]

include::proc_viewing-the-typescript-logs-output-in-the-output-panel.adoc[leveloffset=+1]
