...
* link:{site-baseurl}che-7/tracing-che#installing-jaeger-using-operatorhub-on-openshift-4_{context}[]
* link:{site-baseurl}che-7/tracing-che/#installing-jaeger-using-cli-on-openshift-4_{context}[]
...
include::proc_installing-jaeger-using-cli-on-openshift-4.adoc[leveloffset=+1]
