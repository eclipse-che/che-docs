...
* {prod-short} is deployed in an OpenShift cluster. Verify the state of the deployment in the OpenShift logs. See {viewing-the-state-of-the-cluster-deployment-using-openshift-4-cli-tools}.
