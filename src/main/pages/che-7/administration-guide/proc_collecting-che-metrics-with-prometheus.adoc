...
Latest version is: link:https://+github.com/eclipse/che/blob/master/deploy/openshift/templates/monitoring/prometheus-config.yaml[example prometheus-config.yaml on GitHub]
endif::[]
+
