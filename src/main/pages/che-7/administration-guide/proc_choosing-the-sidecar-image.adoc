...
+
<<<<<<< HEAD:src/main/pages/che-7/end-user-guide/proc_choosing-the-sidecar-image.adoc
[NOTE]
====
...
>>>>>>> 1d34691f... Merge pull request #1466 from boczkowska/Fixes:src/main/pages/che-7/administration-guide/proc_choosing-the-sidecar-image.adoc
