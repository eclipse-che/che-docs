...
*  The {prod} command-line management tool, `{prod-cli}`, is installed. See the link:{site-baseurl}che-7/using-the-{prod-cli}-management-tool/[Using the {prod-cli} management tool] section. Alternatively, the OpenShift command line tool, `oc`, can be used.
* 
