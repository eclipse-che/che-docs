...
* For additional information about custom environment properties and how to define them in CheCluster Custom Resource, see link:https://www.eclipse.org/che/docs/che-7/advanced-configuration-options/[Advanced configuration options].
