...
Keycloak provides built-in support for GitHub, OpenShift, and most common social networks such as Facebook and Twitter. See Instructions to http://link:{keycloak-url}{keycloak-version}/server_admin/server_admin/#github[enable Login with GitHub].
