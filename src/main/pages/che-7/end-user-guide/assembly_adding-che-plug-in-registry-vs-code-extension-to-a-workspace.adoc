...
When the required VS Code extension is added into a {prod-short} plug-in registry, the user can add it into the workspace through the *Che Plugins* panel or through the workspace configuration.
