...
include::assembly_developing-che-theia-plug-ins.adoc[leveloffset=+1]

include::assembly_testing-che-theia-plug-ins.adoc[leveloffset=+1]

include::assembly_publishing-che-theia-plug-ins.adoc[leveloffset=+1]

include::assembly_using-alternative-ides-in-che.adoc[leveloffset=+1]

include::assembly_che-extensibility-reference.adoc[leveloffset=+1]
