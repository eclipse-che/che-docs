...
. In the left navigation panel, in the *Recent Workspaces* section, right-click on the name of a non-running workspace and click on *Run* in the contextual menu to start it.
+
