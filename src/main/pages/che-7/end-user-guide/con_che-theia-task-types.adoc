...
The configuration in link:{site-baseurl}che-7/defining-custom-commands-for-che-theia/[Defining custom commands for Che-Theia] sets up the `theia:watch` and `theia:build` tasks in the `theia` workspace:
