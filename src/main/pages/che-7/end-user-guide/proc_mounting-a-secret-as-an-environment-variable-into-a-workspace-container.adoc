...
----
+
Annotations must indicate that the given secret is mounted as an environment variable, provides variable names, and specify the default mounting behavior.
+
[source,yaml]
----
apiVersion: v1
