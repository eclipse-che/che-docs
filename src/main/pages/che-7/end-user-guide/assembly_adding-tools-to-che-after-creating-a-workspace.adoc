...
[id="adding-tools-to-che-after-creating-a-workspace_{context}"]
= Adding tools to Che after creating a workspace

:context: adding-tools-to-che-after-creating-a-workspace
...
* xref:additional-tools-in-the-che-workspace_{context}[]
* xref:adding-language-support-plug-in-to-the-che-workspace_{context}[]

//* link:{site-baseurl}che-7/additional-tools-in-the-che-workspace[Additional tools in the Che workspace]

//* link:{site-baseurl}che-7/adding-language-support-plug-in-to-the-che-workspace[Adding language support plug-in to the Che workspace]
