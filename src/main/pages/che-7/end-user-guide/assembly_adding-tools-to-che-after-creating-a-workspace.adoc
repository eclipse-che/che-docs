...
* xref:additional-tools-in-the-{prod-id-short}-workspace_adding-tools-to-{prod-id-short}-after-creating-a-workspace[]
* xref:adding-language-support-plug-in-to-the-{prod-id-short}-workspace_adding-tools-to-{prod-id-short}-after-creating-a-workspace[]
