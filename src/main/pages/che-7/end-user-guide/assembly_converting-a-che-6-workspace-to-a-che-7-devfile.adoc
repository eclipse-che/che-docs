...
[id="converting-a-{prod-id-short}-{prod-prev-ver}-workspace-to-a-{prod-id-short}-{prod-ver}-devfile_{context}"]
= Converting a {prod-short} {prod-prev-ver} workspace to a {prod-short} {prod-ver} devfile

:context: converting-a-{prod-id-short}-{prod-prev-ver}-workspace-to-a-{prod-id-short}-{prod-ver}-devfile
