...
This section describes how to manually convert an old {prod-short} {prod-prev-ver} workspace configuration to a {prod-short} {prod-ver} devfile. The following are the benefits of using a {prod-short} 7 devfile:
