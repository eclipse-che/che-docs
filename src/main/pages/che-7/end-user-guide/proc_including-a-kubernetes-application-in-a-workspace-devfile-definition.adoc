...
Note that the `sleep infinity` command is added as the entrypoint of the NodeJS application. This prevents the application from starting at the workspace start phase. It allows the user to start it when needed for testing or debugging purposes.
