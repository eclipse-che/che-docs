...
A Che 7 workspace can be created by pointing the chectl tool to a locally-stored devfile. The Che 7 instance then uses the discovered devfile to build a workspace.
