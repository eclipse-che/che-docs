...
* Maven configuration client, the `settings.xml` file 
* SSH key pairs
...
+
NOTE: SSH key pairs can also be mounted as a file, but this format is primarily aimed at the settings of the Maven configuration client.
