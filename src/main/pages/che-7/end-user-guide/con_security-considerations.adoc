...
All the security-related considerations in this section are only applicable to {prod-short} in multi-user mode. The single user mode does not impose any security restrictions.
