...
* For {prod-short} deployed in the multiuser mode, follow the link:{site-baseurl}che-7/running-che-locally/#deploying-multiuser-che-in-multiuser-mode[Deploying multiuser {prod-short} in the multiuser mode] chapter:
+
endif::[]
