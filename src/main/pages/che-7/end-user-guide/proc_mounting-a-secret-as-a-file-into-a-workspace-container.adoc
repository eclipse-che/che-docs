...
For additional information about Kubernetes annotation items, see: xref:the-use-of-annotations-in-the-process-of-mounting-secret-into-a-workspace-container_{context}[].
