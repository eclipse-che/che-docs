...
For more information on devfiles, see link:{site-baseurl}che-7/configuring-a-workspace-using-a-devfile/[Configuring a {prod-short} workspace using a devfile].
