...
.. xref:creating-a-workspace-from-user-dashboard-get-started_{context}[Get Started view].
.. xref:creating-a-workspace-from-user-dashboard_{context}[Custom Workspace view].
