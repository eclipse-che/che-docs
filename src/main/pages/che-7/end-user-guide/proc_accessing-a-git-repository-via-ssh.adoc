...
* An existing workspace defined on this instance of {prod-short} link:{site-baseurl}che-7/creating-and-configuring-a-new-workspace/[Creating a workspace from user dashboard].
