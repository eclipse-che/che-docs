...
. Run the *SSH: generate key pair for particular host* command.  Do this by pressing 'F1' to bring up the dialogue box, then begin typing 'generate'.  You will be given options for SSH key generation.
