...
List of available Che plugins and more information about registry can be found on the link:https://github.com/eclipse/che-plugin-registry[che-plugin-registry] GitHub.
