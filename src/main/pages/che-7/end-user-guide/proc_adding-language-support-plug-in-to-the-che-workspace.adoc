...
[id="adding-language-support-plug-in-to-the-che-workspace_{context}"]
...
.. Navigate to the {prod-short} Dashboard. See link:{site-baseurl}che-7/navigating-che-using-the-dashboard/[Navigating Che using the Dashboard].
...
+
include::examples/{project-context}-java-language-support.yml[]
+
See the example of the final result:
+
include::examples/{project-context}-workspace-from-the-php-stack-java-language-support.yml[]
