...
This section describes how to convert a {prod-short} {prod-prev-ver} workspace to a {prod-short} {prod-ver} devfile. The result is a basic {prod-short} 7 devfile that can be used for further workspace creation.
