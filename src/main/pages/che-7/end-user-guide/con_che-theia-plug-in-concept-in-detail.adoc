...
Eclipse Che provides a default web IDE for workspaces: Che-Theia. It is based on Eclipse Che-Theia. It is a slightly different version than the plain Eclipse Che-Theia one because there are functionalities that have been added based on the nature of the Eclipse Che workspaces. This version of Eclipse Che-Theia for Che is called *Che-Theia*.

You can extend the IDE provided with Eclipse Che by building a *Che-Theia plug-in*. Che-Theia plug-ins are compatible with any other Eclipse Che-Theia-based IDE.
...
== VS Code extensions and Eclipse Che-Theia plug-ins

A Che-Theia plug-in can be based on a VS Code extension or an Eclipse Che-Theia plug-in.
...
An Eclipse Che-Theia plug-in:: You can build a Che-Theia plug-in by implementing an Eclipse Che-Theia plug-in and packaging it to Eclipse Che.
