...
tags: []
sidebar: che_7_docs
permalink: che-7/customizing-developer-environments.html
...
There are three different ways to customize Eclipse Che:
...
.Che extensibility
image::extensibility/customizing-developer-environments.png[link="{imagesdir}/extensibility/customizing-developer-environments.png"]
