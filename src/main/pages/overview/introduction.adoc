...
Learn more about single and multi-user flavors on the following link:single-multi-user[page].
...
* link:infra-support[Docker]
* link:infra-support[OpenShift]
* Kubernetes (soon)

Learn more about the different infrastructure supported by Eclipse Che on the following link:infra-support[page].
