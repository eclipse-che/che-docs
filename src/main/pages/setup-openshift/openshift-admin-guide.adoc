...
----
* In the multi project case, Eclipse Che will use individual user’s OpenShift tokens to create resources *on behalf of the currently logged-in user*. Refer to the link:openshift-admin-guide#create-workspace-objects-in-personal-namespaces[OpenShift Admin Guide] for more details about how it works.
