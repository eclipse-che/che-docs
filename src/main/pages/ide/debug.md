...
{% include image.html file="debug/breakpoint.png" %}
...
{% include image.html file="debug/debug-configurations.png" %}
...
{% include image.html file="debug/debug.gif" url="images/debug/debug.gif" caption="Click to view a larger image" %}
...
{% include image.html file="debug/debug.png" %}
...
{% include image.html file="debug/php-debugging.gif" %}
...
{% include image.html file="debug/php-debug-configuration.png" %}
...
{% include image.html file="debug/zdebug-settings.png" %}
...
{% include image.html file="debug/zend-debugger-firefox-settings.png" %}
...
{% include image.html file="debug/z-ray-debug.png" %}

That's all!

## NodeJS

The Node.js ready-to-go [stack][stacks] comes with a Node.js debugger module installed and configured. The Dockerfile is located in the [eclipse/che-dockerfiles](https://github.com/eclipse/che-dockerfiles/blob/master/recipes/node/Dockerfile) repository.
...
{% include image.html file="debug/debug-nodejs-config.png" %}
...
{% include image.html file="debug/nodejs-debugger-walkthru.gif" %}
