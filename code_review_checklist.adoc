...
* [ ] *`eclipsefdn/eca`*  is successful: all contributors have signed the Eclipse Contributor Agreement.
...
** [ ] The page contains a redirection for the previous page names.
** Propagate the page name changes in:
...
The technical writer reviewers validate the language with this additional in depth checklist. The docs team do recognize the subjectivity of some of these objectives.
